...
class _ProfileScreenState extends State<ProfileScreen> with TickerProviderStateMixin {
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              // İstatistikler - Daha güzel
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  _buildAnimatedStat("34k", "Followers", 0),
                                  _buildAnimatedStat("560", "Following", 100),
                                  _buildRatingStat("4.9"),
                                ],
                              ),
                            ],
                          ),
  ...
  Widget _buildAnimatedStat(String value, String label, int delay) {
  ...
  Widget _buildRatingStat(String value) {
    return Column(
      children: [
        Row(
          children: [
