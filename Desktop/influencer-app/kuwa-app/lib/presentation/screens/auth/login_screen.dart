...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Future<void> _handleLogin() async {
    ...
    final success =
        await ref.read(authStateProvider.notifier).login(credentials);
    ...
    if (mounted) {
      if (success) {
        ...
        // Auth state güncellendikten sonra manuel olarak navigate et
        context.go('/');
      } else {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text(
                'E-posta veya şifre hatalı! Demo: test@example.com / 123456'),
                      ...
                      children: [
                        ...
                        CustomTextField(
                          ...
                          prefixIcon: Icon(Icons
                              .alternate_email_rounded), // Updated icon from Icons Light SVG
                        ...
                        CustomTextField(
                          ...
                          hint: 'Şifreniz',
                          prefixIcon: Icon(Icons
                              .lock_rounded), // Updated icon from Icons Light SVG
                          obscureText: true,
